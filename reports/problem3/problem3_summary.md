...
| xs | input | Scatter11 | within-group scattering cross section for group 1 | 0.5 | not_configured |
...
| fp | input | pellet_OD | fuel pellet outer diameter | 0.0 | not_configured |
| fp | input | pellet_h | fuel pellet height | 0.0 | not_configured |
...
| rea | input | h_gap | fuel-cladding gap heat-transfer coefficient | 0.0 | max_Tf: negative |
| rea | input | gamma_frac | gamma heating fraction | 0.0 | avg_Tcool: positive |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| chf | RandomForest | 1 | L (m), Xe (-), G (kg m-2s-1) | 0.8333 | 1.0 | 1.0 | high | Key dependencies are physically plausible and response checks are mostly regular. |
...
| bwr | GradientBoosting | 5 | CRD, vanA, vanB | 0.6667 | 1.0 | not_configured | medium | Key dependencies are plausible, but explicit direction checks are limited for this dataset. |
| fp | Ridge | 4 | ax_pow, clad_T, pellet_h | 0.6667 | 1.0 | not_configured | medium | Key dependencies are plausible, but explicit direction checks are limited for this dataset. |
| rea | GradientBoosting | 4 | rod_worth, beta, h_gap | 0.6667 | 1.0 | 1.0 | medium | Most dependencies are plausible, but some response directions need cautious discussion. |
...
| fp | Ridge | 3 | pellet_h | 0.3552 | 0.0311 | 0.0 |
| fp | Ridge | 4 | porosity | 0.2501 | 0.0356 | 1.0 |
| fp | Ridge | 5 | rough_fuel | 0.1128 | 0.0167 | 1.0 |
...
| rea | GradientBoosting | 3 | h_gap | 0.0116 | 0.0005 | 0.0 |
| rea | GradientBoosting | 4 | gamma_frac | 0.0012 | 0.0003 | 0.0 |
